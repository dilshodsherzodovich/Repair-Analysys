export const queryKeys = {
  ...
  defectiveWorks: {
    ...
    journalGroups: "revision-journal-groups",
    echRemarkGroups: "ech-remark-groups",
    echJournal: "ech-revision-journal",
  },
  delays: {
    all: "delays-all",
    ...
    paymentReportDetails: "delays-payment-report-details",
  },
  culprits: {
    all: "culprits-all",
  ...
  componentRegistry: {
    ...
    groupOverview: "component-registry-group-overview",
